...
export const translations = {
  ...
  hindi: {
    ...
    healthReportShared: "परिवार के साथ हेल्थ रिपोर्ट साझा की गई",
  ...
  tamil: {
    ...
    healthcareReady: "ஆரோக்கிய உதவி தயார் நிலையில் உள்ளது",
    ...
    bloodTestResults: "ரத்தப் பரிசோதனை முடிவுகள்",
    bloodPressureRecorded:
      "இரத்த அழுத்தம் பதிவு செய்யப்பட்டது: 120/80 (சாதாரணம்)",
    appointmentBooked:
      "டாக்டர் சர்மாவுடன் சந்திப்பு முன்பதிவு செய்யப்பட்டு உள்ளது",
    ...
    voiceCommands: {
      ...
      goToAppointments: "சந்திப்புகளுக்கு செல்கிறேன்...",
      checkSymptoms: "AI அறிகுறி சரிபார்ப்பாளரை திறக்கிறேன்...",
      emergency: "108 அவசர சேவைகள் அழைக்கப்படுகிறது...",
      familyHealthNav: "குடும்ப உடல்நல கண்ணோட்டம் காட்டப்படுகிறது...",
      bookAppointmentNav: "சந்திப்பு முன்பதிவு திறக்கப்படுகிறது...",
      healthRecords: "உங்கள் உடல்நல பதிவுகள் அணுகப்படுகிறது...",
      callDoctor: "டாக்டர் சர்மாவுடன் இணைக்கப்படுகிறது...",
      medicationReminder: "உங்கள் மருந்து அட்டவணை காட்டப்படுகிறது...",
    },
    ...
    terms:
      "தொடருவதன் மூலம், எங்கள் சேவை விதிமுறைகள் மற்றும் தனியுரிமைக் கொள்கையை நீங்கள் ஏற்கிறீர்கள்",
  ...
  telugu: {
    ...
    bloodPressureRecorded:
      "రక్తపోటు నమోదు చేయబడింది: 120/80 (సాధారణం)",
    appointmentBooked:
      "డాక్టర్ శర్మతో అపాయింట్‌మెంట్ బుక్ చేయబడింది",
    healthReportShared:
      "కుటుంబంతో ఆరోగ్య నివేదిక పంచుకోబడింది",
    ...
    voiceCommands: {
      ...
      goToAppointments: "అపాయింట్‌మెంట్‌లకు వెళ్తున్నాను...",
      checkSymptoms: "AI లక్షణ తనిఖీదారుని తెరవుతున్నాను...",
      emergency: "108 అత్యవసర సేవలకు కాల్ చేస్తున్నాను...",
      familyHealthNav: "కుటుంబ ఆరోగ్య అవలోకనాన్ని చూపుతున్నాను...",
      bookAppointmentNav: "అపాయింట్‌మెంట్ బుకింగ్ తెరవుతున్నాను...",
      healthRecords: "మీ ఆరోగ్య రికార్డులను యాక్సెస్ చేస్తున్నాను...",
      callDoctor: "డా. శర్మతో కనెక్ట్ చేస్తున్నాను...",
      medicationReminder: "మీ మందుల షెడ్యూల్‌ను చూపుతున్నాను...",
    },
    ...
    abhaConnected: "ABHA కనెక్ట్ అయ్యింది",
    abhaHealthId: "హెల్త్ ఐడి",
    abhaViewRecords: "ఆరోగ్య రికార్డులను చూడండి",
  ...
  bengali: {
    ...
    // Dashboard hero + status chips
    healthPriority: "আপনার স্বাস্থ্য আমাদের সর্বোচ্চ অগ্রাধিকার।",
    ...
    availableSchemes: "উপলব্ধ পরিকল্পনা",
    next: "পরবর্তী:",
    ...
    appointmentBooked:
      "ডাঃ শর্মার সাথে অ্যাপয়েন্টমেন্ট বুক করা হয়েছে",
    healthReportShared:
    ...
    voiceCommands: {
      ...
      callDoctor: "ডাঃ শর্মার সাথে সংযোগ করছি...",
      medicationReminder:
  ...
  marathi: {
    ...
    dashboard: "डॅशबोर्ड",
    vitalSigns: "महत्त्वाचे आरोग्य निर्देशक",
    ...
    // Dashboard hero + status chips
    healthPriority: "तुमचे आरोग्य ही आमची सर्वात मोठी प्राथमिकता आहे.",
    ...
    bloodTestResults: "रक्त तपासणी निष्कर्ष",
    bloodPressureRecorded:
      "रक्तदाब नोंदवला: 120/80 (सामान्य)",
    appointmentBooked:
      "डॉ. शर्मा यांच्यासोबत अपॉइंटमेंट बुक करण्यात आली",
    healthReportShared:
      "कुटुंबासोबत आरोग्य अहवाल शेअर करण्यात आला",
    ...
    voiceCommands: {
      ...
      familyHealthNav:
        "कौटुंबिक आरोग्य विहंगावलोकन दाखवत आहे...",
      bookAppointmentNav:
        "अपॉइंटमेंट बुकिंग उघडत आहे...",
      healthRecords: "तुमचे आरोग्य रेकॉर्ड्स पाहत आहे...",
      callDoctor: "डॉ. शर्मा यांच्याशी संपर्क साधत आहे...",
      medicationReminder:
    ...
    signUp: "साइन अप करा",
    terms:
      "पुढे जाताना, आपण आमच्या सेवा अटी आणि गोपनीयता धोरणास सहमती देता",
  ...
  malayalam: {
    ...
    next: "അടുത്തത്:",
    allUpdated: "എല്ലാം അപ്‌ഡേറ്റ് ചെയ്തു",
    ...
    bloodPressureRecorded:
      "രക്തസമ്മർദ്ദം രേഖപ്പെടുത്തി: 120/80 (സാധാരണം)",
    appointmentBooked:
      "ഡോ. ശർമ്മയുമായുള്ള നിയമനം ബുക്ക് ചെയ്തു",
    healthReportShared:
      "കുടുംബത്തോടൊപ്പം ആരോഗ്യ റിപ്പോർട്ട് പങ്കിട്ടു",
    ...
    voiceCommands: {
      greeting:
        "ഹലോ! ഇന്ന് എങ്ങനെ നിങ്ങളെ സഹായിക്കാം?",
      ...
      familyHealthNav:
        "കുടുംബാരോഗ്യ അവലോകനം കാണിക്കുന്നു...",
      bookAppointmentNav:
        "നിയമനം ബുക്ക് ചെയ്യൽ തുറക്കുന്നു...",
      healthRecords:
        "നിങ്ങളുടെ ആരോഗ്യ രേഖകൾ ആക്‌സസ് ചെയ്യുന്നു...",
  ...
  kannada: {
    ...
    voiceCommands: {
      ...
      familyHealthNav:
        "ಕುಟುಂಬದ ಆರೋಗ್ಯ ಅವಲೋಕನ ತೋರಿಸಲಾಗುತ್ತಿದೆ...",
      bookAppointmentNav:
        "ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್ ಬುಕ್ಕಿಂಗ್ ತೆರೆಯಲಾಗುತ್ತಿದೆ...",
      healthRecords:
        "ನಿಮ್ಮ ಆರೋಗ್ಯ ದಾಖಲೆಗಳನ್ನು ಪ್ರವೇಶಿಸಲಾಗುತ್ತಿದೆ...",
      callDoctor: "ಡಾ. ಶರ್ಮಾ ಅವರನ್ನು ಸಂಪರ್ಕಿಸಲಾಗುತ್ತಿದೆ...",
      medicationReminder:
        "ನಿಮ್ಮ ಔಷಧಿಗಳ ವೇಳಾಪಟ್ಟಿಯನ್ನು ತೋರಿಸಲಾಗುತ್ತಿದೆ...",
    },
    ...
    terms:
      "ಮುಂದುವರಿದರೆ, ನೀವು ನಮ್ಮ ಸೇವಾ ನಿಯಮಗಳು ಮತ್ತು ಗೌಪ್ಯತಾ ನೀತಿಯನ್ನು ಒಪ್ಪುತ್ತೀರಿ",
    invalidOtp: "ಅಮಾನ್ಯ OTP. ದಯವಿಟ್ಟು ಮರುಪ್ರಯತ್ನಿಸಿ.",
